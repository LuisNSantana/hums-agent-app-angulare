 ...
 * 
 * NOTE: This is a direct implementation to avoid re-export issues during refactoring
 */
...
import { AuthOperationsService } from './auth/services/auth-operations.service';
import { AuthDataMapper } from './auth/services/auth-data-mapper.service';
